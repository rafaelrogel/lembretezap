...
def get_data_path() -> Path:
    """Get the zapista data directory (~/.zapista)."""
    return ensure_dir(Path.home() / ".zapista")
...
def get_workspace_path(workspace: str | None = None) -> Path:
    ...
    Args:
        workspace: Optional workspace path. Defaults to ~/.zapista/workspace.
    ...
    if workspace:
        ...
        path = Path.home() / ".zapista" / "workspace"

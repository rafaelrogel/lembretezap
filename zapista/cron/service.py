...
from zapista.cron.types import CronJob, CronJobState, CronPayload, CronSchedule, CronStore
...
class CronService:
    ...
    def add_job(
        ...
        # Limite por dia (40 lembretes / 80 total) é aplicado no cron_tool antes de add_job
